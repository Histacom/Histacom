Public Class StartRunner98
    ...
    Private Sub closebutton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles closebutton.Click
        Windows98.startbutton.Location = beginlocation
        Me.Close()
    End Sub
    ...
    Private Sub Start_Runner_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        beginlocation = Windows98.startbutton.Location
        taskbarlenght = Windows98.taskbar.Size.Width
        look.Start()
    End Sub

    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        xlocation = randnumb.Next(1, taskbarlenght)
        Windows98.startbutton.Location = New Point(xlocation, Windows98.startbutton.Location.Y)
    End Sub
