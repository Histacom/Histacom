Public Class Windows95
    ...
    Private Sub windows95_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        desktopicons.Show()
        If My.Resources.The_Microsoft_Sound.CanRead Then
            Dim bStr(My.Resources.The_Microsoft_Sound.Length) As Byte
            My.Resources.The_Microsoft_Sound.Read(bStr, 0, My.Resources.The_Microsoft_Sound.Length)
