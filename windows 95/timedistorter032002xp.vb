Public Class timedistorter032002xp
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim openerror As New Windows_Xp_messagebox
        openerror.errormessage.Text = "Time travel to this year is not completed in the current version of Histacom. bsdn98e5 is the save code for this bad 2002 year. I'll take you to a preview of 2001 but then reload the game back here and choose 2000 next time ;)"
        openerror.Show()
